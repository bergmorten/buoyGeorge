<template>
    <div class="text-h6">Disclaimer for Buoy George</div>
    ...
    <div class="text-bold">Disclaimers for Nortekgroup.cloud</div>

    <p>
        All the information on this website - https://nortekgroup.cloud - and
        its apps is published in good faith and for general information purpose
        only. Nortekgroup.cloud does not make any warranties about the
        ...
        (Nortekgroup.cloud), is strictly at your own risk. Nortekgroup.cloud
    ...
    <div class="text-bold">Update</div>
