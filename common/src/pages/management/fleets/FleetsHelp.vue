<template>
    <p>This is where you view and manage your organization fleets.</p>
    <p>
    ...
    <p>
        If your organization has many fleets, you may choose how many you see on
        each page by clicking "records per page" and selecting the desired
        number.
    </p>
</template>
